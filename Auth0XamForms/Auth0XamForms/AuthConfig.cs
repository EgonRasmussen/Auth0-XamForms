...
public static class AuthConfig
{
    ...
    public const string CallbackUrl = $"{PackageName}://{Domain}/ios/{PackageName}/callback";
    public const string PostLogoutRedirectUri = $"{PackageName}://{Domain}/ios/{PackageName}/callback"; // Anvendes ved Logout

    // WebApi
    public const string BaseUrl = "https://10.0.2.2:5000";                      // Benyttes med Android Emulator
    //public const string BaseUrl = "https://192.168.1.23:5000";                // Benyttes med Device og iOS emulator (husk at tilpasse IP-nummer her og rette portnummer i WebApi launch URL)
}
