...
public static class AuthConfig
{
    ...
    public const string PackageName = "com.companyname.auth0xamforms";

    // Husk også at tilpasse følgende
    // - I Android projektet og klassen OidcCallbackActivity: DataScheme = "<Package name fra AndroidManifest.xml>"
